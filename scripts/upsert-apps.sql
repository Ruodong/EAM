...
INSERT INTO eam.project_app (id, app_id, app_name, app_it_owner, current_state, business_function, app_ownership, app_solution_owner, portfolio_mgt, app_solution_type, app_classification, create_by, create_at)
SELECT gen_random_uuid(), 'A000394', 'LENOVO BID PLATFORM (LBP)', 'cpreddy', 'Active', 'Sales', 'CIO/CDTO', 'lxue', 'Invest', 'Self-Development', 'Business Application', 'system', NOW()
WHERE NOT EXISTS (SELECT 1 FROM eam.project_app WHERE app_id = 'A000394');
UPDATE eam.project_app SET app_name='LENOVO BID PLATFORM (LBP)', app_it_owner=COALESCE(NULLIF(app_it_owner,''), 'cpreddy'), current_state=COALESCE(NULLIF(current_state,''), 'Active'), business_function='Sales', app_ownership='CIO/CDTO', app_solution_owner='lxue', portfolio_mgt='Invest', app_solution_type='Self-Development', app_classification='Business Application', update_by='system', update_at=NOW() WHERE app_id='A000394';
...
INSERT INTO eam.project_app (id, app_id, app_name, app_it_owner, current_state, business_function, app_ownership, app_solution_owner, portfolio_mgt, app_solution_type, app_classification, create_by, create_at)
SELECT gen_random_uuid(), 'A003559', 'EAM', 'na', 'Active', 'IT Management Tool', 'CIO/CDTO', 'zhanghy25', 'Invest', 'Self-Development', 'IT Management Tool', 'system', NOW()
WHERE NOT EXISTS (SELECT 1 FROM eam.project_app WHERE app_id = 'A003559');
UPDATE eam.project_app SET app_name='EAM', app_it_owner=COALESCE(NULLIF(app_it_owner,''), 'na'), current_state=COALESCE(NULLIF(current_state,''), 'Active'), business_function='IT Management Tool', app_ownership='CIO/CDTO', app_solution_owner='zhanghy25', portfolio_mgt='Invest', app_solution_type='Self-Development', app_classification='IT Management Tool', update_by='system', update_at=NOW() WHERE app_id='A003559';
